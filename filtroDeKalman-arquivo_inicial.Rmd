...
Do modo geral, os modelos podem ser classificados como est?ticos ou din?micos, discretos ou cont?nuos, determin?sticos ou estocásticos, paramâtricos ou não paramétricos, lineares ou não lineares. Conforme a classificação, que não são mutuamente excludentes, têm-se as ferramentas adequadas para o estudo do sistema.
